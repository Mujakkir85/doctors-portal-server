...
async function run() {
    ...
    try {
        ...
        app.get('/admin/:email', async (req, res) => {
            ...
            const isAdmin = user.role === 'admin'; // get boolen blue true or false
    ...
    */
        ...
        app.get('/booking', verifyJWT, async (req, res) => {
            const patient = req.query.patient; //why we use this
            //http://localhost:5000/booking?patient=mujakkirlucse@gmail.com
            //by 'req.query.patient;' i get the value from this link . cline site page 'myAppoinment'
...
// const uri = "mongodb+srv://doctor_admin:<password>@cluster0.1buel.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
// const client = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true, serverApi: ServerApiVersion.v1 });
// client.connect(err => {
